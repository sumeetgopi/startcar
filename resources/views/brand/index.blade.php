            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['route' => 'brand.index', 'method' => 'get', 'id' => 'form-search']) !!}
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-4">
                                ...
                                <div class="row" id="pagination" data-url="{!! route('brand.index') !!}">
                                    @include('brand.pagination')
                                </div>
                            </div>
                        </div>
                    </div>

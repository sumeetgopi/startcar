            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['route' => 'unit.index', 'method' => 'get', 'id' => 'form-search']) !!}
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <button class="btn btn-default mt-25" type="button" onclick="window.location.href = '{!! route('unit.index') !!}'">
                                ...
                                <div class="row" id="pagination" data-url="{!! route('unit.index') !!}">
                                    @include('unit.pagination')
                                </div>
                            </div>
                        </div>
                    </div>

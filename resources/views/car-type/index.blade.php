...
<div class="content-wrapper">
    <section class="content-header">
        <div class="row">
            <div class="col-md-6">
                <h2 class="mt-0">Car Type</h2>
            </div>
            <div class="col-md-6 text-right">
                <a href="{!! route('car-type.create') !!}" class="btn btn-success">
                    Create Car Type
                </a>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['route' => 'car-type.index', 'method' => 'get', 'id' => 'form-search']) !!}
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-4">
                                ...
                                <div class="row" id="pagination" data-url="{!! route('car-type.index') !!}">
                                    @include('car-type.pagination')
                                </div>
                            </div>
                        </div>
                    </div>

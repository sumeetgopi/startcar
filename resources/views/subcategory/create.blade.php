...
<div class="content-wrapper">
    ...
    <section class="content">
        {!! Form::open(['route' => 'subcategory.store', 'method' => 'post', 'id' => 'ajax-submit', 'files' => 'true']) !!}
        <div class="row">
            <div class="col-md-6">
                <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('parent_category_id', $parentCategory, null, ['class' => 'form-control select2']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('subcategory_image', 'Sub Category Image') !!}

            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['route' => 'report.tabular', 'method' => 'get', 'id' => 'form-search']) !!}
                                <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <button class="btn btn-default mt-25" type="button" onclick="window.location.href = '{!! route('report.tabular') !!}'">
                                ...
                                <div class="row" id="pagination">
                                    @include('report.tabular.pagination')
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <div class="container">
                <div class="content">
					...
					<div class="tabs btnn">
                        ...
                        <a class="tablinks active" href="{!! route('front.upcoming') !!}">
                                    ...
                                    <table class="table table-striped table-hover table-dark ">
										@if(isset($result) && count($result) > 0)
                                            @foreach($result as $i => $row)
                                                                ...
                                                                <div class="" id="headingOne">
                                                                    <h5 class="mb-0">
                                                                        <a class="btn book-ride" data-toggle="collapse"
                                                                            ...
                                                                            aria-controls="collapseOne">View Details <i
																				class="details"></i>
																		</a>
                                                                    </h5>
                                                                </div>
												...
												<tr id="collapse{!! $i !!}" class="collapse hide" class="collapse hide" aria-labelledby="headingOne"
													...
													<td colspan="5">
														...
														<div class="card-body row" style="color: black;">
															...
															<div class="">
																<div class="col-md-12">
																	<h4>Chosen transport type</h4><br>

...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('asset/custom/checkbox.css') }}" />
...
@include('layout.navbar-top')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {!! date('Y') !!} <a href="#" target="_blank">Product CRM</a>.</strong> All rights reserved.
  </footer>

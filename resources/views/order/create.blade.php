                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('order_name') !!}
                                    {!! Form::text('order_name', null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('order_image') !!} <small>(Multiple)</small>
                                    {!! Form::file('order_image[]', ['class' => 'form-control', 'multiple' => 'multiple']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
